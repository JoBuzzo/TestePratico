<div class="flex flex-col gap-10 p-6 text-gray-900" x-show="selectedClient.id ==! null && selectedProducts.length > 0">
        ...
        <table>
            ...
            <template x-for="product in selectedProducts" :key="product.id">
                <tr class="text-center border border-gray-200 whitespace-nowrap">
                    ...
                    <td class="px-6 py-2" x-text="product.price"></td>
            ...
            <div class="flex flex-col gap-10 ">
                <div class="flex gap-2">
                    <div class="flex flex-col">
                        ...
                        <input type="number" id="parcels" class="w-20 p-2 border-gray-200 rounded-md" min="1"
                            x-model="parcels">
                    </div>
                    <div class="flex flex-col">
...
<div x-show="selectedClient.id === null || selectedProducts.length === 0">
